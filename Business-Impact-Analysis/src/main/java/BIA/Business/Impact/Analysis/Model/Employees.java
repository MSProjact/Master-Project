 ...
 * 
 * here, In Employee model class I have added the 2 new key named ReportToPerson and SunEmployees
 * and generated the getter setter method for it. Also, I have updated the datatype for ReportToid with int eariler it was string. 
 */
